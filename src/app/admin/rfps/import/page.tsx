...
export default async function AdminRFPImportPage() {
      ...
      <div className="flex-1 md:ml-[240px] pt-12 md:pt-0">
        <main className="max-w-2xl mx-auto px-6 py-8">
          ...
          <div className="mb-6">
            ...
            <h1 className="text-xl font-semibold text-[#1A1A18]">Import External RFP</h1>
            <p className="text-sm text-[#6B6A66] mt-1">
              Manually enter an RFP from an external funder. It will be visible to all nonprofits once published.
            </p>
          </div>

          <div className="bg-white rounded-[8px] border border-[#E5E4E0] p-6">
            <RFPForm sourceType="IMPORTED" redirectTo="/admin/rfps/queue" />
          </div>
