        ...
        <main className="max-w-2xl mx-auto px-6 py-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-[#6B6A66] mt-1">
              {profile
                ? "Keep your organization info current so nonprofits get accurate match scores."
                : "Tell us about your foundation before posting your first RFP."}
            </p>
          </div>
              ...
              initialData={
                profile
                  ? {
                      ...
                      annualBudgetRange: profile.annualBudgetRange,
                    }
                  : undefined
              }
            />
